...
#### Why use D3.js? <br>
  ...
  - again, even with added packages, the customization are limited <br>
...
<br>
  ...
  2. Use R only for data processing & use javascript for entire visualization process. We get more customization & these can potentially result in some pretty graphics. 
...
How about one more: https://www.nytimes.com/interactive/2017/04/02/technology/uber-drivers-psychological-tricks.html
...
#### Final words
- we want to show you the customization and visualizations possible with the aid of D3.js
...
- javascript allows you to make tweaks in graphics, and if they're 'data-driven' then D3 will be helpful.
